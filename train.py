...
def train_epoch(model, training_data, optimizer, opt, device, smoothing):
    ...
    for i, batch in enumerate(training_data):
        ...
        # prepare data
        src_seq = patch_src(src, src_pad_idx).to(device)
        ...
        print('step :', round((i / len(training_data)) * 100, 2), '% , loss :', loss.item())
...
def main():
    ...
    opt = parser.parse_args() # opt o day
    ...
    train(transformer, train_iter, valid_iter, optimizer, device, opt)
